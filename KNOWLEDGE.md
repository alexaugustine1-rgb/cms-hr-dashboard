...
**Version:** 3.19.2 | **Last updated:** 13 Jul 2026 — Deployment% now uses DERIVED budget (deployed + open reqs) — contracted_hc was bogus (=headcount) and cleared. Remaining: Elah parser, inline owner/WFH (#26); real contract HC from RMG/TA later.
